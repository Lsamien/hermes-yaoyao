...
section { margin-top: 18px; } h3 { margin: 0 7px 7px; color: var(--text-muted); font-size: 9px; font-weight: 650; letter-spacing: .07em; text-transform: uppercase; } section button { display: flex; width: 100%; min-height: 39px; align-items: center; gap: 9px; padding: 0 9px; border: 0; border-radius: 9px; background: transparent; color: var(--text-secondary); cursor: pointer; text-align: left; } section button:hover, section button.active { background: var(--surface-hover); color: var(--text-primary); } section button.active { font-weight: 610; } section button span { flex: 1; font-size: 11px; } section button small { color: var(--text-muted); font-size: 9px; }
.library-sync { margin-top: auto; padding: 12px 4px 0; border-top: 1px solid var(--line); }.library-sync p { display: flex; align-items: flex-start; gap: 5px; margin: 0 0 8px; color: var(--text-muted); font-size: 9px; line-height: 1.5; }.library-sync p.error { color: var(--danger); }.library-sync .quiet-button { display: flex; width: 100%; gap: 6px; font-size: 10px; }
</style>
