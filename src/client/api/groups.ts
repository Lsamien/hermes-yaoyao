...
export async function getGlobalGroupTopics(cursor?: string, limit = 50): Promise<GroupTopicPage> {
  const payload = unwrapData(await apiRequest<unknown>(apiUrl(`${BASE}/topics`, {
